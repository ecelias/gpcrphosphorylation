...
gnomad_sample = Aim1_G.gnomad_sample
...
def filter_vars(df, dict1):
    ...
    for index, row in df.iterrows():
        ...
        if Aim1_G.getSeq(current_id) is not None:
...
#filtered_gnomad = filter_vars(gnomad, FINAL_sites)
#Aim1_G.to_csv(filtered_gnomad, 'gnomad_filtered')
