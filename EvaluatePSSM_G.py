...
import pandas as pd
import Aim1_G
import PSSMDictionaries as p
import operator

st_pssm = Aim1_G.st_pssm
y_pssm = Aim1_G.y_pssm
st_pssm_dict = p.st_pssm_dict
y_pssm_dict = p.y_pssm_dict
...
#psp_rankings_dict = pickle.load(open("psp_ranked_dict.p", "rb"))
